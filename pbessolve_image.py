'''
pbessolve
Extracts a global solution to an image model generated by image2mcrl2 and 
formula constructed by slcs2modalmu

NOTE: The Boolean representing whether a BES_Equation is a solution to Phi is
susceptible to the automatic fixed point naming convention of mCRL2. If this
ever changes, the regex check should be altered too.
